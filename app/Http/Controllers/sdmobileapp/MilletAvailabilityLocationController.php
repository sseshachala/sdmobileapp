...
class MilletAvailabilityLocationController extends Controller
{
    ...
    public function showAll()
    {
        ...
        foreach($rows as $row)
        {
            ...
            $obj->	description = '<b>Contact:</b>b>'.$row->contact_name.'<br><b>Phone:</b>'.$row->contact_phone.'<br><div class="mapouter"><div class="gmap_canvas"><iframe width="400" height="300" id="gmap_canvas" src="https://maps.google.com/maps?q='.urlencode($row->address).'&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.emojilib.com">emojilib.com</a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div>';
